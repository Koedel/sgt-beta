                                    ...
                                    <div class="panel-body collapse in">
                                        <div id="example_wrapper" class="dataTables_wrapper" role="grid">
                                            <form name="associacoes" method="POST" id="associacoes">
                                                <div class="row">
                                                    <div class="col-xs-5">
                                                        <input class="form-control" name="associacao" placeholder="Razão Social" value="<?php echo($associacao); ?>" type="text">
                                                    </div>
                                                    <div class="col-xs-5">
...
<?php if ($assoaciacoes->rowCount() > 0) { ?>
                                                <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered datatables dataTable sortable" id="example" aria-describedby="example_info">
                                                    <thead>
                                                        <tr role="row">
                                                            <th class="sorting_asc" role="columnheader" tabindex="1" aria-controls="example" rowspan="1" colspan="1" aria-sort="ascending" aria-label="" style="width:150px;">Razão Social</th>
...
<?php } ?>
                                                ...
                                                <div style="margin-left:30px;width:100px;float:left;">
                                                    ...
                                                    <a onclick="location.href = '?pagina=' + $('#pagina_ir').val() + '&nome=<?php echo($associacao); ?>'" style="float:left; width: 25px; height: 26px; margin-left: 5px; margin-top: 3px;" class="btn btn-muted btn-default"><i class="icon-arrow-right" ></i></a>
                                                </div>
                                            </ul>
                                        </div>
                                    </div>
