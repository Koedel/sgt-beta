...
<?php } ?>
                                                ...
                                                <div style="margin-left:30px;width:100px;float:left;">
                                                    ...
                                                    <a onclick="location.href = '?pagina=' + $('#pagina_ir').val() + '&nome=<?php echo($tipoveiculo); ?>'" style="float:left; width: 25px; height: 26px; margin-left: 5px; margin-top: 3px;" class="btn btn-muted btn-default"><i class="icon-arrow-right" ></i></a>
                                                </div>                                
                                            </ul>
                                        </div>            
                                    </div>
